...
@DisplayName("ViewTimesheetPermissionChecker Tests")
class ViewTimesheetPermissionCheckerTests {
	...
	void testCheckPermissionCandidateExistsPerformsAccessControlCheck() {
		...
		// When
		assertThatCode(() -> this.viewTimesheetPermissionChecker.checkPermission(context)).doesNotThrowAnyException();
	...
	void testCheckPermissionWithBulkContextCandidateExistsPerformsAccessControlCheck() {
		...
		// When
		assertThatCode(() -> this.viewTimesheetPermissionChecker.checkPermissionWithBulkContext(context, bulkContext))
