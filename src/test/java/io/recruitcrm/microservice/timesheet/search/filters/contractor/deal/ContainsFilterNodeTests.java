...
@DisplayName("ContractorDeal ContainsFilterNode Tests")
class ContainsFilterNodeTests {

	private static final int SINGLE_CONDITION_COUNT = 1;

	private static final String DB_FIELD = "dealName";
	...
	@DisplayName("Get filter conditions should return deal condition for valid filter values")
	void testGetFilterConditionsValidFilterValuesReturnDealCondition(String filterValue) {
	...
	@DisplayName("Get filter conditions should return and false condition for invalid or empty filter values")
	void testGetFilterConditionsInvalidOrEmptyFilterValuesReturnAndFalseCondition(String filterValue) {
		List<Condition> conditions = this.getFilterConditionsForValue(filterValue);
	...
	private List<Condition> getFilterConditionsForValue(String filterValue) {
		return this.createNode(filterValue).getFilterConditions();
	}
