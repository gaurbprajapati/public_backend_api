...
@DisplayName("AssociatedDeal DoesNotContainFilterNode Tests")
class DoesNotContainFilterNodeTests {
	...
	@DisplayName("Get filter conditions should return NOT EXISTS condition for valid filter value")
	void testGetFilterConditionsValidFilterValueReturnsNotExistsCondition(String filterValue) {
	...
	void testGetGroupByFieldsReturnsEmptyList() {
		...
		// When
		List<Field<?>> groupByFields = doesNotContainFilterNode.getGroupByFields();
