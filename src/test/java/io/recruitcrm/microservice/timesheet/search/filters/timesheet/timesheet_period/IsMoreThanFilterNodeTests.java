...
@DisplayName("TimesheetPeriod IsMoreThanFilterNode Tests")
class IsMoreThanFilterNodeTests {
	...
	@Test
	@DisplayName("Get filter conditions should return condition for valid days value")
	void testGetFilterConditionsValidDaysValueReturnsCondition() {
		FilterDto filterDto = new FilterDto();
		filterDto.setDbField("timesheetPeriod");
		filterDto.setFilterType(FilterTypes.IS_MORE_THAN);
		filterDto.setFilterValue("10");
		filterDto.setGroupType("AND");

		this.filterNodeContext.setFilterDto(filterDto);
		IsMoreThanFilterNode filterNode = new IsMoreThanFilterNode(this.filterNodeContext);
