...
@DisplayName("Job DoesNotContainFilterNode Tests")
class DoesNotContainFilterNodeTests {
	...
	@Test
	@DisplayName("Get filter conditions should return NOT IN condition for comma-separated job IDs")
	void testGetFilterConditionsCommaSeparatedJobIdsReturnsNotInCondition() {
		// Given
