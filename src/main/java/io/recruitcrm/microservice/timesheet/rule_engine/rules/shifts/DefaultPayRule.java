...
/**
 * Range-based Default Pay rule. Pays any worked time that remained unallocated after all
 * other rules (including Weekly Overtime) ran, at the base pay/bill rate × 1.0.
 *
...
public class DefaultPayRule extends BaseRule {
	...
	public String getName() {
		return "Range-Based Default Pay Rule";
	}
