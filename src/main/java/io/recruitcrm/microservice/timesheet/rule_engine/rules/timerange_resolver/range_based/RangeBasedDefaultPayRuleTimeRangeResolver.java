...
/**
 * Range-based resolver for the Default Pay rule. Registered with the rule factory for
 ...
 */
public class RangeBasedDefaultPayRuleTimeRangeResolver implements ICustomRuleTimeRangeResolver {

	public RangeBasedDefaultPayRuleTimeRangeResolver(Logger logger) {
