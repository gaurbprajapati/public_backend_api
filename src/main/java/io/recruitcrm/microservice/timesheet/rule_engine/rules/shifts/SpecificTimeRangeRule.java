...
/**
 * Rule for calculating specific time range based on shifts
 */
public class SpecificTimeRangeRule extends BaseRule {
	...
	public SpecificTimeRangeRule(Logger logger) {
		super(logger);
	}
	...
	public String getName() {
		return "Range-Based Specific Time Range Rule";
	}

	@Override
	protected RuleType getDefaultRuleType() {
		return RuleType.RANGE_BASED_SPECIFIC_TIME_RANGE;
	}
