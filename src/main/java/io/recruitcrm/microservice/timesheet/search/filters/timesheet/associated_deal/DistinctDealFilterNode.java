...
/**
 * Base for timesheet associated-deal filter nodes that select DISTINCT timesheet rows
 * without any GROUP BY/HAVING clause.
 */
public abstract class DistinctDealFilterNode extends AssociatedDealFieldBaseFilterNode {
