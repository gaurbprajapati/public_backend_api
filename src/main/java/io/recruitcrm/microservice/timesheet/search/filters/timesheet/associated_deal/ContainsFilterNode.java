...
/**
 * Filter node for "contains" logic - matches timesheets that have ALL of the specified
 * deals (but can have additional deals as well). Uses GROUP BY with HAVING COUNT to
 * ensure all specified deals are present.
 */
public class ContainsFilterNode extends AssociatedDealFieldBaseFilterNode {
